...
C     fCoriCos  :: Coriolis Cos(phi) parameter at grid Center point (for NH)
     ...
     &  fCori, fCoriG, fCoriCos
      ...
      _RS dAHybSigF      (Nr)
      _RS dAHybSigC      (Nr+1)
      _RS bHybSigmF      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr+1,nSx,nSy)
      _RS bHybSigmC      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RS dBHybSigF      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RS dBHybSigC      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr+1,nSx,nSy)
